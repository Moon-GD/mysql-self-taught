...
- 개발자의 커리어를 FE부터 시작하게 되지만 BE에서도 제일 앞서나갈 수 있는 양손잡이 개발자가 되는 것 (중간 목표의 초기 과정)
- 그렇게 Web에 어느 정도 숙달된다면 Data Analysis 혹은 AI를 공부하고 Developed-Web을 설계하는 사람이 되는 것 (중간 목표의 중간 과정)
